<template>
   <div>
    ...
    <table id="harness_table" class="center">
  <thead>
    <tr>
      <th>Race Number</th>
      <th>Meeting Name</th>
  ...
  <tbody>
    <tr v-for="item in harness_races" v-bind:key="item.race_number">
...
import axios from 'axios';
  const HARNESS_KEY = "161d9be2-e909-4326-8c2c-35ed71fb460b"
  export default {
    name: 'harness',
    data() {
      return {
    ...
    methods: {
      ...
      fetch_data() {
        ...
        for (var key in this.races) {
          ...
          if (value.category_id == HARNESS_KEY) {
            this.harness_races.push(value)
            count += 1;
          }
        }
        this.harness_races.sort(function(a, b) {
